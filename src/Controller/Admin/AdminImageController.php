...
class AdminImageController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin_image/index.html.twig', [
    ...
    public function new(Request $request, ImageRepository $imageRepository): Response
    {
        ...
        return $this->renderForm('admin/admin_image/new.html.twig', [
            'image' => $image,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/admin_image/show.html.twig', [
            'image' => $image,
        ]);
    }
    ...
    public function edit(Request $request, Image $image, ImageRepository $imageRepository): Response
    {
        ...
        return $this->renderForm('admin/admin_image/edit.html.twig', [
            'image' => $image,
            'form' => $form,
        ]);
    }
